...
* Week 13: Text cleaning and bag-of-words analysis (ch 12)
** Opening prayer
...
- Quiz on today's material and the last DataCamp session
- One [optional] programming challenge: clean a corpus from stop-words
...
- Part 2: Markov chain text generation: injecting randomness,
  generating bigrams, creating a lookp table and generate text.
