...
- *DataCamp lesson*: Intro to functions in Python - arguments and scope
- *Programming assignments:* Pick at least one of the exercises 7.9.2-7.9.6 and submit your
  solution in a Colab notebook with explanations. I will share my
  sample solutions with you via GitHub next week. All of them together
  will probably take you 90 minutes, with the last one taking up to
  30-45 minutes.
- *Quiz* covering DataCamp and today's classroom session.
...
- To seamlessly continue last week's session, download my notebook and
  upload it either to your local Jupyter lab, or to the cloud
  instance: [[https://tinyurl.com/string-search-ipynb][tinyurl.com/strings-search-ipynb]] (raw ipynb file)
