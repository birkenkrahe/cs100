...
- [ ] *Opening prayer*
- [ ] *Info:* Changes to the Teams dashboard
- [ ] *Review:* What did you achieve this week?
- [ ] *Review:* Code along as I explore Pythagoras' theorem
- [ ] *Info:* Next week (June 5th) there will be *no class meeting*
- [ ] *New assignments* for the next two weeks: reading + quiz + code
- [ ] *Closing prayer*
...
- Open the starter code from my GitHub gists in Colab:
  ~gist.github.com/birkenkrahe/~ -> =Arithmetic exercises (Starter)=

  or: [[https://tinyurl.com/arithmetic-exercises][tinyurl.com/arithmetic-exercises]] (there's a button)
  
- Solve the exercises on your own (no AI), then let's compare

- The last two exercises are given as a bonus assignment for home

- There is also a harder bonus assignment with tricky formulas,
  "Formula translator" (graded)

** Code along: Pythagoras

- Open this gist on GitHub: [[https://tinyurl.com/python-pythagoras][tinyurl.com/python-pythagoras]]

- Open the gist in Colab (there's a button)
